...
public class StringUtil {
	...
	public static String getEncodeUrl(String url) {
		...
		if (StringUtil.isChinese(fileName)) {
			try {
				encodeUrl = url.replace(fileName,
	 ...
	 * 150、151、152、157、158、159、182、187、188 联通：130、131、132、155、156、185、186
	 * 电信：133、153、180、189 <br>
	 * 130-139 <br>
	 * 153,155,156, <br>
	...
	public static boolean isValidUserName(String userName) {
		...
		Matcher matcher = Pattern.compile(
				"[a-zA-Z\u4e00-\u9fa5][a-zA-Z0-9\u4e00-\u9fa5]{2,11}").matcher(
				userName);
